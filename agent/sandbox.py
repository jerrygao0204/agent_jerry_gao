...
#             tool_names: Optional[List[str]] = None,          # 💡 [新增] 允许传入工具名称列表
#             tool_dispatcher: Optional[Any] = None) -> Dict[str, Any]:
#         """
#         沙箱安全执行入口
...
#         exec_globals = dict(global_vars or {})
#         if tool_dispatcher and tool_names:
#             for t_name in tool_names:
#                 exec_globals[t_name] = tool_dispatcher.build_proxy(t_name)
#         # 1. AST 静态安全审查
