...
@mcp.tool(name="search_knowledge_base", description="检索用户手册及 FAQ")
...
@mcp.tool(name="get_dashboards", description="查询系统仪表板元数据")
def mcp_get_dashboards(keyword: str = "") -> str:
    tool = tool_factory.get_tool("get_dashboards")
    if tool:
