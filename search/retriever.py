...
#     @property
#     def model(self):
#         return Retriever._shared_model

#     @property
#     def tokenizer(self):
#         return Retriever._shared_tokenizer
    
#     def _init_embedding_engine(self):
#         """跨實例安全的單例加載與預熱稠密向量化模型"""
#         # 第一重檢查：若已完成加載，快速返回
#         if Retriever._shared_model is None or Retriever._shared_tokenizer is None:
#             # 跨實例共享線程鎖
#             with Retriever._shared_lock:
...
#                     # 賦值給類別變數
#                     Retriever._shared_tokenizer = tokenizer
#                     Retriever._shared_model = model
